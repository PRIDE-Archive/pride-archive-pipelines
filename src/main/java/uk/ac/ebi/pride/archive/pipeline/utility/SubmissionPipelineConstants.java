...
public class SubmissionPipelineConstants {
  ...
  public enum PrideArchiveJobNames {
      ...
      PRIDE_ARCHIVE_SYNC_MISSING_PROJECTS_ORACLE_PC("syncMissingProjectsOracleToPCJob", "This job will sync missing projects from Oracle into ProteomeXchange"),
    ...
    public enum PrideArchiveStepNames{
       ...
       PRIDE_ARCHIVE_SOLR_CLOUD_DELETE_COLLECTION("deletePrideArchiveCollectionSolrCloudStep",
        ...
        PRIDE_ARCHIVE_MISSING_PROJ_ORACLE_TO_PC_SYNC("syncMissingProjectOracleToPC",
